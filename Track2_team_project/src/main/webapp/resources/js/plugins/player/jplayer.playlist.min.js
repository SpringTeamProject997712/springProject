...
//==========================================================
        ...
        a(this.cssSelector.jPlayer).bind(a.jPlayer.event.ready, function() {
            e._init() //일단 처음에 _init 동작함. 밑에 있음.
        }), 
...
//===================================jPlayerPlaylist function 끝 ==================================================   
    ...
    jPlayerPlaylist.prototype = { 
        ...
        select: function(b) {
            ...
            b >= 0 && b < this.playlist.length ? (this.current = b, this._highlight(b), //--> 매개변수가 0이니 이거 실행함
            console.log("select에서의 a"),
            console.log(a),
        ...
        play: function(c) {
            ...
            c >= 0 && c < this.playlist.length ? this.playlist.length && (this.select(c), a(this.cssSelector.jPlayer).jPlayer("play")) : c === b && a(this.cssSelector.jPlayer).jPlayer("play")
        },
        pause: function() {
