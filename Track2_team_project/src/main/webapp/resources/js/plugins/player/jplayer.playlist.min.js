...
//==========================================================
        ...
        this.options = a.extend(!0, { // a.extend(!0, {keyBindings,stateClass},this.option, d)
            keyBindings: {
                next: {
                    key: 221,
                    fn: function() {
        ...
        this.options.fullScreen || a(this.cssSelector.details).hide(), a(this.cssSelector.playlist + " ul").empty(), 
        this._createItemHandlers(), 
        a(this.cssSelector.jPlayer).jPlayer(this.options)
    }, 
//===================================jPlayerPlaylist function 끝 ==================================================   

		//FUNCTION.prototype은 FUNCTION을 상속받은 객체가 사용한 메서드를 정의한다. 
    jPlayerPlaylist.prototype = { 
        ...
        select: function(b) {
            b = 0 > b ? this.original.length + b : b, b >= 0 && b < this.playlist.length ? (this.current = b, this._highlight(b), a(this.cssSelector.jPlayer).jPlayer("setMedia", this.playlist[this.current])) : this.current = 0 //setMedia(노래 작동, 환경설정)
        },
        play: function(c) {
