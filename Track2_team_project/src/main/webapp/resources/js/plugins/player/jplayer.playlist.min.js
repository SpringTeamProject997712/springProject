...
//================================================================================================================   
    ...
    jPlayerPlaylist.prototype = { 
        ...
        _init: function() {
            ...
            a.current= prevCurrent? prevCurrent : 0 ;
            if(prevCurrent){a._highlight(prevCurrent)} 
            //타임 있다면
        ...
        play: function(c, prevTime) {
        	prevTime = prevTime || 0 ;
	    	c = 0 > c ? this.original.length + c : c, 
	    	c >= 0 && c < this.playlist.length ? this.playlist.length && (this.select(c), a(this.cssSelector.jPlayer).jPlayer("play", prevTime))
	    		: c === b && a(this.cssSelector.jPlayer).jPlayer("play", prevTime)
        },
        pause: function() {
        ...
        next: function() {
            ...
            this.loop ? 0 === a && this.shuffled && this.options.playlistOptions.shuffleOnLoop && this.playlist.length > 1 ? this.shuffle(!0, !0) 
            	: this.play(a) : a > 0 && this.play(a)
        },
        previous: function() {
