...
//===========================내가 선언한 메서드================================================
		a(this.cssSelector.goRemove).on("click", function(a){
			a.preventDefault(),
			e.remove(d),
			e.blur(this)
		}),
		console.log("내가 지정한 지시자가 무엇입니까"),
		console.log(this.cssSelector.goRemove),
//============================================================================================ 
             ...
             : this.removing ? !1 : 
             	(c = 0 > c ? d.original.length + c : c, 
            		c >= 0 && c < this.playlist.length && (this.removing = !0,  
            			a(this.cssSelector.playlist + " li:nth-child(" + (c + 1) + ")").slideUp(this.options.playlistOptions.removeTime, 
            				function() { 
                				...
                				d.original.length ? c === d.current ? (d.current = c < d.original.length ? d.current : d.original.length - 1, d.select(d.current)) 
                				: c < d.current && d.current-- : (a(d.cssSelector.jPlayer).jPlayer("clearMedia"), d.current = 0, d.shuffled = !1, d._updateControls()), 
			            	d.removing = !1
			            	}
			            )
					), 
