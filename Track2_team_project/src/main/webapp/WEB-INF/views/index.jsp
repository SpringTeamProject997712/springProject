		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				...
				<div class="ms_banner_text">
					<h1>This Monthâs</h1>
					<h1 class="ms_color">
						<a href="/album/album_single?abno=${bestAlbum.abno}&pageName=menu_album">Record Breaking Albums ! <br>${bestAlbum.name}</a>
					</h1>
					<p>
						Dream your moments, Until I Met You, Gimme Some Courage, Dark Alley, One More Of A Stranger, Endless<br> Things, The Heartbeat Stops, Walking Promises, Desired Games and many more...
					</p>
					<div class="ms_banner_btn">
						<a href="/album/album_single?abno=${bestAlbum.abno}&pageName=menu_album" class="ms_btn">Go Now</a> <a href="javascript:void(0)" class="ms_btn album_add_queue" id="run_abno_${bestAlbum.abno}">Add To Queue</a>
					</div>
				</div>
			</div>
		</div>
				...
				<c:forEach var="top" items="${topalbum}" begin="0" end="4">
					...
					<div class="ms_weekly_box" id="this_track_pbno_${top.pbno}">
						...
						<div class="weekly_right">
							<span class="w_song_time">${top.length}</span> <span class="ms_more_icon" data-other="1"> <img src="../images/svg/more.svg" alt="">
							</span>
						</div>
						<ul class="more_option">
			...
			<c:forEach var="list" items="${list}">
				<div class="swiper-slide">
					<div class="ms_rcnt_box">
						<div class="ms_rcnt_box_img">
							...
							<div class="ms_main_overlay">
								...
								<div class="ms_play_icon album_play_button" id="playAbno_${list.abno}">
									<a href="javascript:void(0)"> <img src="../images/svg/play.svg" alt="">
									</a>
								</div>
							</div>
						</div>
						<div class="ms_rcnt_box_text">
							<h3>
								<a href="/album/album_single?abno=${list.abno}">${list.name}</a>
							</h3>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="ms_genres_box">
						<img src="/images/genres/romantic.svg" alt="" class="img-fluid" />
						<div class="ms_main_overlay">
							<div class="ms_box_overlay"></div>
							<div class="ms_play_icon">
								<img src="/images/svg/play.svg" alt="">
							...
							<div class="ovrly_text_div">
								<span class="ovrly_text1"><a href="/genres/genres_single?genre=1">romantic</a></span> <span class="ovrly_text2"><a href="/genres/genres_single?genre=1">view song</a></span>
							</div>
						</div>
				...
				<div class="col-lg-6">
					<div class="ms_genres_box">
						...
						<div class="ms_main_overlay">
							...
							<div class="ovrly_text_div">
								<span class="ovrly_text1"><a href="/genres/genres_single?genre=2">Hiphop</a></span> <span class="ovrly_text2"><a href="/genres/genres_single?genre=2">view song</a></span>
							</div>
						</div>
						<div class="ms_box_overlay_on">
							<div class="ovrly_text_div">
				...
				<div class="col-lg-12" style="height: 255px">
					<div class="ms_genres_box">
						...
						<div class="ms_main_overlay">
							...
							<div class="ovrly_text_div">
								<span class="ovrly_text1"><a href="/genres/genres_single?genre=3">Dancing</a></span> <span class="ovrly_text2"><a href="/genres/genres_single?genre=3">view song</a></span>
							</div>
						</div>
						<div class="ms_box_overlay_on">
							<div class="ovrly_text_div">
				...
				<div class="col-lg-12">
					<div class="ms_genres_box">
						...
						<div class="ms_main_overlay">
							...
							<div class="ovrly_text_div">
								<span class="ovrly_text1"><a href="/genres/genres_single?genre=4">Rock</a></span> <span class="ovrly_text2"><a href="/genres/genres_single?genre=4">view song</a></span>
							</div>
						</div>
						<div class="ms_box_overlay_on">
							<div class="ovrly_text_div">
				...
				<div class="col-lg-6">
					<div class="ms_genres_box">
						...
						<div class="ms_main_overlay">
							...
							<div class="ovrly_text_div">
								<span class="ovrly_text1"><a href="/genres/genres_single?genre=5">Jazz</a></span> <span class="ovrly_text2"><a href="/genres/genres_single?genre=5">view song</a></span>
							</div>
						</div>
						<div class="ms_box_overlay_on">
							<div class="ovrly_text_div">
				...
				<div class="col-lg-6">
					<div class="ms_genres_box">
						...
						<div class="ms_main_overlay">
							...
							<div class="ovrly_text_div">
								<span class="ovrly_text1"><a href="/genres/genres_single?genre=6">Metal</a></span> <span class="ovrly_text2"><a href="/genres/genres_single?genre=6">view song</a></span>
							</div>
						</div>
						<div class="ms_box_overlay_on">
							<div class="ovrly_text_div">
				...
				<div class="col-lg-6">
					<div class="ms_genres_box">
						...
						<div class="ms_main_overlay">
							...
							<div class="ovrly_text_div">
								<span class="ovrly_text1"><a href="/genres/genres_single?genre=7">Pop</a></span> <span class="ovrly_text2"><a href="/genres/genres_single?genre=7">view song</a></span>
							</div>
						</div>
						<div class="ms_box_overlay_on">
							<div class="ovrly_text_div">
				...
				<div class="col-lg-6">
					<div class="ms_genres_box">
						...
						<div class="ms_main_overlay">
							...
							<div class="ovrly_text_div">
								<span class="ovrly_text1"><a href="/genres/genres_single?genre=8">Indie</a></span> <span class="ovrly_text2"><a href="/genres/genres_single?genre=8">view song</a></span>
							</div>
						</div>
						<div class="ms_box_overlay_on">
							<div class="ovrly_text_div">
				...
				<div class="col-lg-12">
					<div class="ms_genres_box">
						...
						<div class="ms_main_overlay">
							...
							<div class="ovrly_text_div">
								<span class="ovrly_text1"><a href="/genres/genres_single?genre=9">Soul</a></span> <span class="ovrly_text2"><a href="/genres/genres_single?genre=9">view song</a></span>
							</div>
						</div>
						<div class="ms_box_overlay_on">
							<div class="ovrly_text_div">
