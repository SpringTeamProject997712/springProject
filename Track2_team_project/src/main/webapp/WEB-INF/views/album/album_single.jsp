...
<div class="ms_album_single_wrapper">
	<div class="album_single_data abno_${view[0].abno}">
		...
		<div class="album_single_text">
			...
			<div class="album_btn">
				<a href="#" class="ms_btn play_btn"><span class="play_all"><img src="/images/svg/play_all.svg" alt="">Play All</span> <span class="pause_all"><img src="/images/svg/pause_all.svg" alt="">Pause</span></a> <a href="#" class="ms_btn"> <span class="play_all"><img src="/images/svg/add_q.svg" alt="">Add To Queue</span></a> <a href="#" class="ms_btn"> <span class="insert_cart_btn"><img src="/images/svg/right_arrow.svg" alt="">Add to Cart</span></a>
...
<form role="form" method="post">
	<input type="text" name="pbno" id="pbno" value="${pbno.pbno}" /> <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
</form>
