		...
		<div class="ms_sidemenu_wrapper">
			...
			<div class="ms_sidemenu_inner">
				...
				<div class="ms_nav_wrapper">
					<ul>
						<li><a href="javascript:void(0)" class="menu active" id="menu_main" title="Discover"> <span class="nav_icon"> <span class="icon icon_discover"></span>
							</span> <span class="nav_text"> メイン </span>
						</a></li>
						<li><a href="javascript:void(0)" class="menu" id="menu_album" title="Albums"> <span class="nav_icon"> <span class="icon icon_albums"></span>
							</span> <span class="nav_text"> アルバム </span>
						</a></li>
						<li><a href="/artist/artist.jsp" title="menu_artists" onclick="pageSubmitFn('artist')"> <span class="nav_icon"> <span class="icon icon_artists"></span>
							</span> <span class="nav_text"> アーティスト </span>
						</a></li>
						<li><a href="genres.html" title="Genres" onclick="pageSubmitFn('genre')"> <span class="nav_icon"> <span class="icon icon_genres"></span>
							</span> <span class="nav_text"> ジャンル </span>
						</a></li>
						<li><a href="top_track.html" title="Top Tracks" onclick="pageSubmitFn('top_track')"> <span class="nav_icon"> <span class="icon icon_tracks"></span>
							</span> <span class="nav_text"> トップトラック </span>
						</a></li>


					</ul>
					<ul class="nav_downloads">
						<li><a href="download.html" title="Downloads"> <span class="nav_icon"> <span class="icon icon_download"></span>
							</span> <span class="nav_text"> ダウンロード </span>
						</a></li>
						<li><a href="/member/my_cart" title="Purchased"> <span class="nav_icon"> <span class="icon icon_purchased"></span>
							</span> <span class="nav_text"> 購買リスト </span>
						</a></li>
						<li><a href="favourite.html" title="Favourites"> <span class="nav_icon"> <span class="icon icon_favourite"></span>
							</span> <span class="nav_text"> お気に入り </span>
						</a></li>
						<li><a href="history.html" title="History"> <span class="nav_icon"> <span class="icon icon_history"></span>
							</span> <span class="nav_text"> ヒストリー </span>
						</a></li>
					</ul>
					<ul class="nav_playlist">
						<li><a href="/feature_playlist/feature_playlist" title="Featured Playlist"> <span class="nav_icon"> <span class="icon icon_fe_playlist"></span>
							</span> <span class="nav_text"> プレイリスト </span>
						</a></li>
						<li><a href="/member/my_playlist/my_playlist" title="Create Playlist"> <span class="nav_icon"> <span class="icon icon_c_playlist"></span>
			...
			<div class="ms_header">
				<div class="ms_top_left">
					<div class="ms_top_search">
						<form>
							<input type="text" id="track_tracker" class="form-control" placeholder="ミュージック検索"> <span id="entire_music_searcher" class="search_icon"> <img src="/images/svg/search.svg" alt="">
							</span>
						</form>
						<div class="instant_table_wrapper" id="instant_table_wrapper"></div>
					</div>
				...
				<div class="ms_top_right">
					...
					<sec:authorize access="isAnonymous()">
						<div class="ms_top_btn">
							<a href="javascript:;" class="ms_btn reg_btn" data-toggle="modal" data-target="#myModal"><span>新規登録</span></a> <a href="javascript:;" class="ms_btn login_btn" data-toggle="modal" data-target="#myModal1"><span>ログイン</span></a>
						</div>
					</sec:authorize>
					<sec:authorize access="isAuthenticated()">
						<sec:authentication property="principal" var="principal" />
						<div class="ms_top_btn">
							<a href="upload.html" class="ms_btn">upload</a> <a href="javascript:;" class="ms_admin_name">Hello Bella <span class="ms_pro_name">ns</span>
							</a>
