	...
	<div class="container-lg">
		...
		<div class="card mb-4">
			<div class="card-header">
				<strong>트랙 관리</strong><span class="small ms-1">트랙 세부 정보 확인 / 수정</span>
			</div>
			<div class="card-body">
				...
				<div class="example">
					<div class="tab-content rounded-bottom">
						<form name="formTrack" method="post" action="/track/updateTrack" class="row g-3" enctype="multipart/form-data">
							...
							<div class="col-md-6">
								<label class="form-label" for="tbno">트랙 고유번호</label> <input class="form-control" name="tbno" id="tbno" type="text" value="${track.tbno}" readonly="readonly">
							</div>
							<div class="col-md-6">
								<label class="form-label" for="track_name">트랙 타이틀</label> <input class="form-control" name="name" id="track_name" type="text" value="${track.name}">
							</div>
							<div class="col-md-4">
							...
							<div class="col-md-4">
								<label class="form-label" for="track_price">가격</label> <input class="form-control" name="price" id="track_price" type="text" value="${track.price}">
							</div>
							<div class="col-md-4">
								...
								<div class="input-group">
									...
									<label for="songname"> <a class="btn btn-outline-secondary ms_btn" type="button"> 트랙 변경 </a>
									</label> <input type="file" name="uploadMusic" id="songname" accept=".mp3" class="upload-hidden" style="display: none" />
								</div>
							</div>

							<div class="col-12">
								<label class="form-label" for="track_detail">상세</label> <input class="form-control" name="detail" id="track_detail" type="text" value="${track.detail}" style="height: 150px;">
							</div>
							<div class="col-12">
